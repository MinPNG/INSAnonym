...
<div class="jumbotron">
    <div class="row">
        <div class="col-md-6">
            <h1><?php echo $language['RANKING_DESC']; ?></h1>
        </div>
        <div class="col-md-6">
                     <form class="form-inline float-right">
                         ...
                         <select name="team[]" class="selectpicker" multiple data-style="btn-outline-primary mr-sm-2" data-live-search="true">
                          ...
                          <br><br>
                          <input class="btn btn-primary" type="submit" value="<?php echo $language['RANKING_FILTER']; ?>">
                    </form>
        </div>
    </div>
</div>
              ...
              <table class="table table-sm table-bordered">
                <thead class="black">
                  <tr class="table-danger">
                    <th scope="col"><?php echo $language['RANKING_COL1']; ?></th>
                    <th scope="col"><?php echo $language['RANKING_COL11']; ?></th>
                    <th scope="col"><?php echo $language['RANKING_COL3']; ?></th>
                    <th scope="col"><?php echo $language['RANKING_COL4']; ?></th>
                  </tr>
                </thead>
                <tbody>
...
<div class="bs-docs-section">
<table class="table" data-locale="<?php echo $lang; ?>" data-toggle="table">
      <thead class="table-success">
        <tr>
          <th scope="col" data-sortable="true">#</th>
          <th scope="col" data-sortable="true"><?php echo $language['RANKING_COL11']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL12']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL13']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL14']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL3']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL16']; ?></th>
        </tr>
      </thead>
      <tbody>
    ...
    <table class="table" data-locale="<?php echo $lang; ?>" data-toggle="table">
      <thead class="table-warning">
        <tr>
          ...
          <th scope="col"><?php echo $language['RANKING_COL22']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL23']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL4']; ?></th>
          <th scope="col"><?php echo $language['RANKING_COL16']; ?></th>
        </tr>
      </thead>
